...
# SOUL = persona seule. L'abaque n'est PLUS injecté au modèle : le chiffrage
# est déterministe via ./devis (qui lit data/abaque-filtration.md). Le RAG
# garde catalogue/clients/devis/mails.
